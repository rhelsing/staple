...
describe Staple::ImportGenerator, type: :generator do
  SNIPPETS = {
  ...
  SNIPPETS.each do |snippet, templates|
    ...
    if templates.include?("scss")
      it "imports SCSS file for #{snippet.humanize}" do
        ...
        assert_file "app/assets/stylesheets/staple/_#{snippet.dasherize}.scss"
      end
    end
    ...
    if templates.include?("erb")
      it "imports ERB template for #{snippet.humanize}" do
        ...
        assert_file "app/views/staple/_#{snippet.underscore}.html.erb"
      end
    end
    ...
    if templates.include?("js")
      it "imports JS file for #{snippet.humanize}" do
        ...
        assert_file "app/assets/javascripts/staple/#{snippet.underscore}.js"
      end
    end
